...
firstPrologue = [
    ...
    -- any
    DeclFunT (Just (0, 0)) (VarIdent "any") (TypArr (Just (0, 0))
        (TypArr (Just (0, 0)) 
            (TypVar (Just (0, 0)) (VarIdent "a")) 
            (TypCon (Just (0, 0)) (ConIdent "Bool"))
        )
    ...
    DeclFunc (Just (0, 0)) (VarIdent "any") [VarIdent "p",VarIdent "lst"] (
        ExpMth (Just (0, 0)) (ExpVar (Just (0, 0)) (VarIdent "lst")) [
            MatchT (Just (0, 0)) (Pat (Just (0, 0)) (PatLL (Just (0, 0)) (PatVar (Just (0, 0)) (VarIdent "x")) (PatVar (Just (0, 0)) (VarIdent "xs")))) (ExpOr (Just (0, 0)) (ExpApp (Just (0, 0)) (ExpVar (Just (0, 0)) (VarIdent "p")) (ExpVar (Just (0, 0)) (VarIdent "x"))) (ExpApp (Just (0, 0)) (ExpApp (Just (0, 0)) (ExpVar (Just (0, 0)) (VarIdent "any")) (ExpVar (Just (0, 0)) (VarIdent "p"))) (ExpVar (Just (0, 0)) (VarIdent "xs")))),
            MatchT (Just (0, 0)) (Pat (Just (0, 0)) (PatLst (Just (0, 0)) [])) (ExpLit (Just (0, 0)) (LitFalse (Just (0, 0))))
        ]
    ),

    -- length
    DeclFunT (Just (0, 0)) (VarIdent "length") (TypArr (Just (0, 0)) 
        (TypLst (Just (0, 0)) (TypVar (Just (0, 0)) (VarIdent "a"))) 
        (TypCon (Just (0, 0)) (ConIdent "Integer"))
    ),
    DeclFunc (Just (0, 0)) (VarIdent "length") [VarIdent "lst"] (
        ExpMth (Just (0, 0)) (ExpVar (Just (0, 0)) (VarIdent "lst")) [
            MatchT (Just (0, 0)) (Pat (Just (0, 0)) (PatLL (Just (0, 0)) (PatVar (Just (0, 0)) (VarIdent "x")) (PatVar (Just (0, 0)) (VarIdent "xs")))) (ExpAdd (Just (0, 0)) (ExpLit (Just (0, 0)) (LitInt (Just (0, 0)) 1)) (OpAdd (Just (0, 0))) (ExpApp (Just (0, 0)) (ExpVar (Just (0, 0)) (VarIdent "length")) (ExpVar (Just (0, 0)) (VarIdent "xs")))),
            MatchT (Just (0, 0)) (Pat (Just (0, 0)) (PatLst (Just (0, 0)) [])) (ExpLit (Just (0, 0)) (LitInt (Just (0, 0)) 0))
        ]
    ),
    ...
    DeclFunc (Just (0, 0)) (VarIdent "reverse") [VarIdent "lst"] (
        ExpMth (Just (0, 0)) (ExpVar (Just (0, 0)) (VarIdent "lst")) [
            MatchT (Just (0, 0)) (Pat (Just (0, 0)) (PatLst (Just (0, 0)) [PatVar (Just (0, 0)) (VarIdent "x")])) (ExpLst (Just (0, 0)) [ExpVar (Just (0, 0)) (VarIdent "x")]),
